...
txt3("Programming Languages", "`Python`, `C`")
txt3("Developer Tools", "`VS Code`, `Git`, `GitHub`, `Google Cloud Platform (GCP)`, `Jupyter Notebook`, `PyCharm`")
txt3("Technologies & Frameworks", "`TensorFlow`, `Azure`, `Keras`, `YOLO (v5, v8, v11)`, `SAM2`, `OpenCV`, `Hugging Face`, `Streamlit`, `Google API`, `Gradle`, `Maven`")
